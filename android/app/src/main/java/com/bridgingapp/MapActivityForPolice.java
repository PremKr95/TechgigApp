...
public class MapActivityForPolice extends FragmentActivity {
...
//        l1.setVisibility(View.GONE);
    ...
    private SupportMapFragment getMapFragment() {
        return (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapfragmentPolice);
    }

    private void initialize() {

        setContentView(R.layout.activity_map_for_police);
...
//        l1.setVisibility(View.GONE);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.FROYO) {
            success = com.here.android.mpa.common.MapSettings.setIsolatedDiskCacheRootPath(
...
//                        }
                        ...
                        MapMarker mapMarker2 = new MapMarker(new GeoCoordinate(19.124376, 73.008951) , imageGreen );
                        ...
                        MapMarker mapMarker5 = new MapMarker(new GeoCoordinate(19.124408, 73.016011) , imageBlack );
